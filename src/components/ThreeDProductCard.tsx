      ...
      >
        <Card 
          className={cn(
            ...
            // Borde: look premium por defecto en mobile, sutil en desktop
            "border-white/[0.18] md:border-white/[0.08] md:hover:border-white/20",
            // Sombra/Glow: Replicando look iluminado por defecto en mobile
            "shadow-[0_0_35px_rgba(255,255,255,0.06),0_20px_60px_rgba(0,0,0,0.45)] md:shadow-2xl",
            // Interacción Mobile vs Desktop
            isActive 
              ? "scale-[0.98] shadow-[0_0_0_1px_rgba(255,255,255,0.18),0_0_30px_rgba(255,255,255,0.08)] md:scale-[1.02] md:border-white/20 md:shadow-[0_0_40px_rgba(255,255,255,0.08),0_20px_70px_rgba(0,0,0,0.55)]" 
              : "scale-100"
          )}
          style={{
        ...
        >
          ...
          {/* En mobile este glow es el estado base, se quita momentáneamente al tocar */}
          <div 
            className={cn(
