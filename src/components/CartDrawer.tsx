          ...
          <div className="p-8 space-y-6 border-t border-white/5 bg-[#111111]/50 backdrop-blur-md">
            ...
            <div className="flex flex-col gap-3">
              <Button 
                ...
                className="w-full h-14 rounded-2xl bg-white text-black hover:bg-[#EAEAEA] font-black text-xs uppercase tracking-widest shadow-xl transition-all active:scale-95"
              >
              ...
              <SheetClose asChild>
                <Button variant="ghost" className="w-full h-12 text-[10px] font-black uppercase tracking-widest text-muted-foreground hover:text-white">
